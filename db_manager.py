...
import pandas as pd
# The methods create_tables and insert_dataframe mentioned here are redundant. This is not required but in case, the SQLite_database.py was not run and there is no placement.db created, this method will create empty tables.
